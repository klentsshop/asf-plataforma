      ...
      {cargando ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {clientesActivos.map((c) => (
            <div
              key={c._id}
              className="bg-white p-8 rounded-[3rem] shadow-xl border border-emerald-100 relative group overflow-hidden transition-all hover:border-emerald-500"
            >
              ...
              <h4 className="text-2xl font-black text-[#1a1a1a] uppercase italic mb-1">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 bg-[#1a1a1a] text-[#D4AF37] py-4 rounded-2xl text-[9px] font-black uppercase italic tracking-widest hover:bg-black transition-all"
                >
                  Gestionar Bóveda
                </button>

                <button
                  className="px-4 bg-slate-50 text-slate-400 rounded-2xl hover:text-blue-500 transition-colors"
                >
