      ...
      <div className="bg-[#F9FAFB] border-4 border-[#D4AF37]/10 p-10 rounded-[2.5rem] relative z-10 text-left">
        ...
        <div className="flex justify-between items-center mb-8 border-b-2 border-slate-200 pb-5">
          <div className="flex items-center gap-3 text-left">
            ...
            <p className="text-[#1a1a1a] text-xs font-black uppercase tracking-widest italic text-left">
              Dictamen Técnico Actualizado
            </p>
          </div>
          <span className="text-[9px] text-[#D4AF37] font-black uppercase tracking-widest italic bg-[#1a1a1a] px-3 py-1 rounded-full border border-[#D4AF37]/30">
            Cifrado AES-256
          </span>
        </div>
        ...
        {datosCaso?.presupuestoEstimado && !datosCaso?.pagoValidado && (
          <div className="pt-10 border-t-2 border-dashed border-slate-200 flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <label className="bg-[#1a1a1a] text-white hover:text-[#D4AF37] px-10 py-5 rounded-2xl text-[11px] font-black uppercase tracking-[0.2em] transition-all cursor-pointer shadow-2xl italic border-2 border-[#D4AF37] hover:scale-[1.05] active:scale-95 text-center flex items-center gap-3">
              {subiendoArchivo ? (
        ...
        {datosCaso?.comprobantePago && !datosCaso?.pagoValidado && (
          <div className="mt-8 bg-amber-500/10 border-2 border-amber-500/20 p-4 rounded-2xl flex items-center gap-3 animate-pulse text-left">
            ...
            <p className="text-[9px] text-amber-600 font-black uppercase italic tracking-widest text-left">
        ...
        {datosCaso?.estado === 'concluido' && !datosCaso?.rating && (
          <div className="mt-10 pt-10 border-t-4 border-[#D4AF37]/20">
            <BovedaResena 
